 ...
 * Size: 18 px
 * Bpp: 4
 * Opts: --bpp 4 --size 18 --font Z:/home/alejo/Documents/Repositories/ProyectoFinal/Prototipos/Inversor 555/Interfaz de Usuario/Proyecto Interfaz/assets/fonts/Montserrat-Medium.ttf -o Z:/home/alejo/Documents/Repositories/ProyectoFinal/Prototipos/Inversor 555/Interfaz de Usuario/Proyecto Interfaz/assets/fonts\ui_font_fontMontserratM18Tildes.c --format lvgl -r 0x20-0x7f --symbols ÁÉÍÓÚáéíóú --no-compress --no-prefilter
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 5694, .adv_w = 211, .box_w = 15, .box_h = 17, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 5822, .adv_w = 193, .box_w = 11, .box_h = 17, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 5916, .adv_w = 89, .box_w = 6, .box_h = 17, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 5967, .adv_w = 242, .box_w = 15, .box_h = 17, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 6095, .adv_w = 228, .box_w = 12, .box_h = 17, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 6197, .adv_w = 172, .box_w = 10, .box_h = 14, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 6267, .adv_w = 176, .box_w = 11, .box_h = 14, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 6344, .adv_w = 80, .box_w = 5, .box_h = 14, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 6379, .adv_w = 183, .box_w = 11, .box_h = 14, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 6456, .adv_w = 195, .box_w = 10, .box_h = 14, .ofs_x = 1, .ofs_y = 0}
};

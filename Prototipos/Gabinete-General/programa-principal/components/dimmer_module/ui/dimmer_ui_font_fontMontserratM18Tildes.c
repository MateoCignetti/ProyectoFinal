 ...
 * Size: 18 px
 * Bpp: 1
 * Opts: --bpp 1 --size 18 --font Z:/home/alejo/Documents/Repositories/utilities/(0) UI_FINALES/UI_Dimmer/proyecto_SLS/assets/fonts/Montserrat-Medium.ttf -o Z:/home/alejo/Documents/Repositories/utilities/(0) UI_FINALES/UI_Dimmer/proyecto_SLS/assets/fonts\dimmer_ui_font_fontMontserratM18Tildes.c --format lvgl -r 0x20-0x7f --symbols ÁÉÍÓÚáéíóú --no-compress --no-prefilter
 ******************************************************************************/

#include "dimmer_ui.h"

#ifndef UI_FONT_FONTMONTSERRATM18TILDES
#define UI_FONT_FONTMONTSERRATM18TILDES 1
#endif

#if UI_FONT_FONTMONTSERRATM18TILDES
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    /* U+00E9 "é" */
    0x3, 0x1, 0x80, 0x80, 0x0, 0x1e, 0x18, 0x66,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 1304, .adv_w = 211, .box_w = 13, .box_h = 17, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1332, .adv_w = 193, .box_w = 9, .box_h = 17, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1352, .adv_w = 89, .box_w = 4, .box_h = 17, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1361, .adv_w = 242, .box_w = 13, .box_h = 17, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1389, .adv_w = 228, .box_w = 11, .box_h = 17, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1413, .adv_w = 172, .box_w = 8, .box_h = 14, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1427, .adv_w = 176, .box_w = 10, .box_h = 14, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1445, .adv_w = 80, .box_w = 4, .box_h = 14, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1452, .adv_w = 183, .box_w = 10, .box_h = 14, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1470, .adv_w = 195, .box_w = 9, .box_h = 14, .ofs_x = 2, .ofs_y = 0}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t dimmer_ui_font_fontMontserratM18Tildes = {
#else
lv_font_t dimmer_ui_font_fontMontserratM18Tildes = {
#endif
...
#endif /*#if UI_FONT_FONTMONTSERRATM18TILDES*/

 ...
 * Size: 16 px
 * Bpp: 1
 * Opts: --bpp 1 --size 16 --font Z:/home/alejo/Documents/Repositories/utilities/(0) UI_FINALES/UI_Dimmer/proyecto_SLS/assets/fonts/Montserrat-Medium.ttf -o Z:/home/alejo/Documents/Repositories/utilities/(0) UI_FINALES/UI_Dimmer/proyecto_SLS/assets/fonts\dimmer_ui_font_fontMontserratM16Tildes.c --format lvgl -r 0x20-0x7f --symbols ÁÉÍÓÚáéíóú --no-compress --no-prefilter
 ******************************************************************************/

#include "dimmer_ui.h"

#ifndef UI_FONT_FONTMONTSERRATM16TILDES
#define UI_FONT_FONTMONTSERRATM16TILDES 1
#endif

#if UI_FONT_FONTMONTSERRATM16TILDES
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t dimmer_ui_font_fontMontserratM16Tildes = {
#else
lv_font_t dimmer_ui_font_fontMontserratM16Tildes = {
#endif
...
#endif /*#if UI_FONT_FONTMONTSERRATM16TILDES*/

 ...
 * Size: 14 px
 * Bpp: 1
 * Opts: --bpp 1 --size 14 --font Z:/home/alejo/Documents/Repositories/utilities/(0) UI_FINALES/UI_Dimmer/proyecto_SLS/assets/fonts/Montserrat-Medium.ttf -o Z:/home/alejo/Documents/Repositories/utilities/(0) UI_FINALES/UI_Dimmer/proyecto_SLS/assets/fonts\dimmer_ui_font_fontMontserratM14Tildes.c --format lvgl -r 0x20-0x7f --symbols ÁÉÍÓÚáéíóú --no-compress --no-prefilter
 ******************************************************************************/

#include "dimmer_ui.h"

#ifndef UI_FONT_FONTMONTSERRATM14TILDES
#define UI_FONT_FONTMONTSERRATM14TILDES 1
#endif

#if UI_FONT_FONTMONTSERRATM14TILDES
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t dimmer_ui_font_fontMontserratM14Tildes = {
#else
lv_font_t dimmer_ui_font_fontMontserratM14Tildes = {
#endif
...
#endif /*#if UI_FONT_FONTMONTSERRATM14TILDES*/

 ...
 * Size: 16 px
 * Bpp: 1
 * Opts: --bpp 1 --size 16 --font Z:/home/alejo/Documents/Repositories/utilities/(0) UI_FINALES/UI_Inversor/proyecto_SLS/assets/fonts/Montserrat-Medium.ttf -o Z:/home/alejo/Documents/Repositories/utilities/(0) UI_FINALES/UI_Inversor/proyecto_SLS/assets/fonts\inverter_ui_font_fuenteMontserratM16Tildes.c --format lvgl -r 0x20-0x7f --symbols ÁÉÍÓÚ-áéíóú --no-compress --no-prefilter
 ******************************************************************************/

#include "inverter_ui.h"

#ifndef UI_FONT_FUENTEMONTSERRATM16TILDES
#define UI_FONT_FUENTEMONTSERRATM16TILDES 1
#endif

#if UI_FONT_FUENTEMONTSERRATM16TILDES
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0xfc, 0x3f, 0x5, 0xc2, 0x61, 0x3c, 0xb3, 0xf0,
    0x20, 0x10,
    ...
    /* U+0026 "&" */
    0x3e, 0x18, 0xc6, 0x31, 0x9c, 0x3e, 0xf, 0x7,
    0xc3, 0x99, 0xc3, 0xf0, 0x66, 0x1c, 0xf9,
    ...
    0xf0, 0x9, 0x1, 0x98, 0x11, 0x83, 0x8, 0x20,
    ...
    0x34, 0x7, 0x60, 0x63, 0xc, 0xf, 0x80,
    ...
    /* U+00E1 "á" */
    0xc, 0x18, 0x0, 0x7c, 0x46, 0x3, 0x3, 0x7f,
    0xc3, 0xc3, 0xc7, 0x7b,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 57, .adv_w = 176, .box_w = 10, .box_h = 12, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 72, .adv_w = 54, .box_w = 1, .box_h = 4, .ofs_x = 1, .ofs_y = 8},
    {.bitmap_index = 73, .adv_w = 86, .box_w = 4, .box_h = 15, .ofs_x = 2, .ofs_y = -3},
    {.bitmap_index = 81, .adv_w = 87, .box_w = 4, .box_h = 15, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 89, .adv_w = 102, .box_w = 5, .box_h = 6, .ofs_x = 1, .ofs_y = 6},
    {.bitmap_index = 93, .adv_w = 149, .box_w = 8, .box_h = 8, .ofs_x = 1, .ofs_y = 2},
    {.bitmap_index = 101, .adv_w = 58, .box_w = 2, .box_h = 5, .ofs_x = 1, .ofs_y = -3},
    ...
    {.bitmap_index = 253, .adv_w = 58, .box_w = 2, .box_h = 12, .ofs_x = 1, .ofs_y = -3},
    ...
    {.bitmap_index = 351, .adv_w = 183, .box_w = 11, .box_h = 12, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 368, .adv_w = 211, .box_w = 11, .box_h = 12, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 385, .adv_w = 172, .box_w = 8, .box_h = 12, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 397, .adv_w = 163, .box_w = 8, .box_h = 12, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 409, .adv_w = 198, .box_w = 10, .box_h = 12, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 424, .adv_w = 208, .box_w = 10, .box_h = 12, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 439, .adv_w = 79, .box_w = 2, .box_h = 12, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 442, .adv_w = 131, .box_w = 7, .box_h = 12, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 453, .adv_w = 184, .box_w = 10, .box_h = 12, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 468, .adv_w = 152, .box_w = 8, .box_h = 12, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 480, .adv_w = 244, .box_w = 12, .box_h = 12, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 498, .adv_w = 208, .box_w = 10, .box_h = 12, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 513, .adv_w = 215, .box_w = 12, .box_h = 12, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 531, .adv_w = 185, .box_w = 9, .box_h = 12, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 545, .adv_w = 215, .box_w = 13, .box_h = 14, .ofs_x = 1, .ofs_y = -2},
    ...
    {.bitmap_index = 799, .adv_w = 157, .box_w = 9, .box_h = 9, .ofs_x = 1, .ofs_y = 0},
    ...
    {.bitmap_index = 858, .adv_w = 157, .box_w = 9, .box_h = 12, .ofs_x = 1, .ofs_y = 0},
    ...
    {.bitmap_index = 1060, .adv_w = 187, .box_w = 12, .box_h = 15, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1083, .adv_w = 172, .box_w = 8, .box_h = 15, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1098, .adv_w = 79, .box_w = 4, .box_h = 15, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1106, .adv_w = 215, .box_w = 12, .box_h = 15, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1129, .adv_w = 202, .box_w = 10, .box_h = 15, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1148, .adv_w = 153, .box_w = 8, .box_h = 12, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1160, .adv_w = 157, .box_w = 9, .box_h = 12, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1174, .adv_w = 71, .box_w = 4, .box_h = 12, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1180, .adv_w = 163, .box_w = 9, .box_h = 12, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1194, .adv_w = 173, .box_w = 8, .box_h = 12, .ofs_x = 1, .ofs_y = 0}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t inverter_ui_font_fuenteMontserratM16Tildes = {
#else
lv_font_t inverter_ui_font_fuenteMontserratM16Tildes = {
#endif
...
#endif /*#if UI_FONT_FUENTEMONTSERRATM16TILDES*/

 ...
 * Size: 14 px
 * Bpp: 1
 * Opts: --bpp 1 --size 14 --font Z:/home/alejo/Documents/Repositories/utilities/(0) UI_FINALES/UI_Inversor/proyecto_SLS/assets/fonts/Montserrat-Medium.ttf -o Z:/home/alejo/Documents/Repositories/utilities/(0) UI_FINALES/UI_Inversor/proyecto_SLS/assets/fonts\inverter_ui_font_fuenteMontserrat14Tildes.c --format lvgl -r 0x20-0x7f --symbols ÁÉÍÓÚ-áéíóú --no-compress --no-prefilter
 ******************************************************************************/

#include "inverter_ui.h"

#ifndef UI_FONT_FUENTEMONTSERRAT14TILDES
#define UI_FONT_FUENTEMONTSERRAT14TILDES 1
#endif

#if UI_FONT_FUENTEMONTSERRAT14TILDES
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    /* U+00E1 "á" */
    0x18, 0xc0, 0x1e, 0x8c, 0x17, 0xe1, 0x86, 0x37,
    0x40,

    /* U+00E9 "é" */
    0xc, 0x20, 0x1, 0xc4, 0x50, 0x7f, 0xc0, 0x80,
    0x88, 0xf0,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 775, .adv_w = 164, .box_w = 10, .box_h = 14, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 793, .adv_w = 150, .box_w = 7, .box_h = 14, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 806, .adv_w = 69, .box_w = 3, .box_h = 14, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 812, .adv_w = 188, .box_w = 10, .box_h = 14, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 830, .adv_w = 177, .box_w = 8, .box_h = 14, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 844, .adv_w = 134, .box_w = 6, .box_h = 11, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 853, .adv_w = 137, .box_w = 7, .box_h = 11, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 863, .adv_w = 62, .box_w = 3, .box_h = 11, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 868, .adv_w = 142, .box_w = 8, .box_h = 11, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 879, .adv_w = 152, .box_w = 7, .box_h = 11, .ofs_x = 1, .ofs_y = 0}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t inverter_ui_font_fuenteMontserrat14Tildes = {
#else
lv_font_t inverter_ui_font_fuenteMontserrat14Tildes = {
#endif
...
#endif /*#if UI_FONT_FUENTEMONTSERRAT14TILDES*/

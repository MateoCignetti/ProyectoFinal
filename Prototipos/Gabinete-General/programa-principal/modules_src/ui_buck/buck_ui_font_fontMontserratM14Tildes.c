 ...
 * Size: 14 px
 * Bpp: 1
 * Opts: --bpp 1 --size 14 --font Z:/home/alejo/Documents/Repositories/utilities/(0) UI_FINALES/UI_Buck/proyecto_SLS/assets/fonts/Montserrat-Medium.ttf -o Z:/home/alejo/Documents/Repositories/utilities/(0) UI_FINALES/UI_Buck/proyecto_SLS/assets/fonts\ui_font_fontMontserratM14Tildes.c --format lvgl -r 0x20-0x7f --symbols ÁÉÍÓÚáéíóú --no-compress --no-prefilter
 ******************************************************************************/
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t ui_font_fontMontserratM14Tildes = {
#else
lv_font_t ui_font_fontMontserratM14Tildes = {
#endif

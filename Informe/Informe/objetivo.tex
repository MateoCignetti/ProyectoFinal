...
\begin{itemize}[noitemsep]
    \item Diseñar un sistema didáctico modular para la experimentación de electrónica de potencia, con el fin de facilitar el aprendizaje práctico mediante el uso de módulos especializados y material teórico complementario.
    %Facilitar el aprendizaje práctico de electrónica de potencia mediante un sistema didáctico modular que permita la experimentación directa y el desarrollo de competencias a través de módulos especializados y material teórico complementario.
\end{itemize}

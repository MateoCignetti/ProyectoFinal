...
Los trabajos mencionados ponen en manifiesto la necesidad de contar con un dispositivo didáctico que aproxime los contenidos teóricos a la práctica, favoreciendo el trabajo docente, la comprensión de los alumnos y con capacidad de expansión a distintos contextos académicos. Sin embargo, muchos de estos desarrollos únicamente se centran en el desarrollo de aplicaciones específicas sin abarcar otras temáticas de interés. Además, cabe destacar que en en la región no se dispone de ninguna solución o dispositivo similar. En este contexto, el presente proyecto busca aportar una alternativa integral, modular y accesible, que facilite la enseñanza, y que también se mantenga vigente frente a la evolución tecnológica. 

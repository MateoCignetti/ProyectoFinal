...
\snsubsection{Contribución del proyecto}

Los trabajos mencionados ponen en manifiesto la necesidad de contar con un dispositivo didácticos que aproximen los contenidos teóricos a la práctica, favoreciendo el trabajo docente y la comprensión de los alumnos y, además, adaptable a distintos contextos académicos. Sin embargo, muchos de estos desarrollos únicamente se centran en el desarrollo de aplicaciones específicas sin abarcar otras temáticas de interés. En este contexto, el presente proyecto busca aportar una alternativa integral, modular y accesible, que no solo facilite la enseñanza, sino que también se mantenga vigente frente a la evolución tecnológica. Y, además, que incentive a estudiantes y entusiastas el estudio de electrónica de potencia.

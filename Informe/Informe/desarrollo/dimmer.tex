...
\begin{figure}[H]
    ...
    \caption{Tensión de capacitor con dos diferentes ángulos de fase. \textcolor{red}{((Referencia: Thyristor Theory and Design Considerations: Handbook))}}
...
\subsubsection{Circuito detector de cruce por cero (ZCD)} %No se puede hacer un subsubsub :( ver como cambiar
...
Como el microcontrolador se encuentra aislado galvánicamente del circuito de corriente alterna del TRIAC y la carga, se diseñó un simple driver con un optoacoplador con salida TRIAC MOC3021M \textcolor{red}{DATASHEET}.
...
\textcolor{red}{SEGUIR ACÁ, ver igual esta sección}

...
El recortador de onda "Dimmer" tiene como objetivo regular la potencia entregada a la carga, mediante el uso de un tiristor, recortando la onda de tensión aplicada a la carga. En esta placa, se utilizan dos métodos distintos de control: analógico y digital.
...
\begin{figure}[H]
    ...
    \includegraphics{dimmer/circuito.png}

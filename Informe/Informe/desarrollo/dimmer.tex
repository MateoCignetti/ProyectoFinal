...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \draw (9, 3) to[variable american resistor, l={$R_T$}, label distance=0.1cm, mirror] (9, 6);
        \draw (11.98, 2.996) to[empty bidirectionaldiode, l={$D$}, label distance=-0.3cm] (9, 3);
        \draw (12.75, 6) to[empty triac, l={$Q$}, label distance=-0.3cm, mirror] (12.75, 1.393);
        \node[shape=rectangle, draw, line width=1pt, inner sep=0, minimum width=1.465cm, minimum height=0.817cm] at (7.5, -0.001){} node [anchor=center, align=center, text width=1.077cm, inner sep=5.5pt] at (7.5, -0.001){Carga};
...
\begin{figure}[H]
    ...
    \caption{Circuito detector de cruce por zero.}
